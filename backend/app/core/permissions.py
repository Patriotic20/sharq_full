...
PERMISSIONS: tuple[PermissionDef, ...] = (
    ...
    PermissionDef("employees:write", "Create employees"),
    PermissionDef("employees:update", "Update employees"),
    PermissionDef("employees:delete", "Delete employees"),
    PermissionDef("employe_info:read", "View employee info"),
    PermissionDef("employe_info:write", "Create employee info"),
    PermissionDef("employe_info:update", "Update employee info"),
    PermissionDef("employe_info:delete", "Delete employee info"),
    PermissionDef("positions:read", "View positions"),
    PermissionDef("positions:write", "Create positions"),
    PermissionDef("positions:update", "Update positions"),
    PermissionDef("positions:delete", "Delete positions"),
